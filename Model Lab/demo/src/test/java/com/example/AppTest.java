...
{ 
   ...
   {  
    PropertyConfigurator.configure("E:\\Users\\huzaif\\Selenium\\OpenTable(Model)\\log4j2.properties");
   ...
   {
       FileInputStream fi=new FileInputStream("E:\\Users\\huzaif\\Selenium\\OpenTable(Model)\\example.xlsx");
